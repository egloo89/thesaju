export const ja = {
  ...
  result: {
    ...
    labels: {
      tabFortune: '✨ 運勢結果', tabPillars: '☯ 四柱八字',
      analyzing: '分析中...', generating: '生成中...',
      linkCopied: 'リンクをコピーしました！',
      pdfTitle: '総合四柱分析レポート (FULL VERSION)',
      calSolar: '新暦', calLunar: '旧暦入力',
      male: '男性', female: '女性',
      ...
      myElement: '私の代表五行',
      unit: '個', ageSuffix: '歳~',
      timeUnknownNote: '⚠ 時柱は含まれません',
      energyTpl: '{el}の気 · {animal}',
      footerNote: '本レポートは伝統万歳暦の計算と命理学の解釈に基づいています',
      shareTitle: 'THE SAJU — 私の四柱結果',
      shareText: '{animal} · {hanja}日干 · THE SAJUで私の四柱を確認しました！',
    },
    luckGuide: {
      title: '開運＆厄除けガイド',
      favorable: '私に良いもの (吉)',
    ...
    emailSend: '送信', emailSending: '送信中...',
    emailSuccess: 'レポートをメールで送信しました！',
    emailFail: '送信に失敗しました。再試行してください。',
